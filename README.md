...
Each registered task also has **Run now**, which starts it immediately exactly
as its schedule would (after a confirmation). While it runs, the button shows
*Running...* and the status refreshes itself until the run finishes.
